...
import { useConnectedUsers, useMyId, useIsTogether } from 'react-together'
  ...
  useEffect(() => {
    ...
    const hideSpinner = () => {
      ...
      if (spinnerOverlay) {
        ...
        console.log('👥 Hidden multisynq loading spinner in friend suggestions (main)', { sessionStatus })
      }
