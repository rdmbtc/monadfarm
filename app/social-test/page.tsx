...
import { VanillaMultisynqSocialFeed } from '@/components/vanilla-multisynq-social-feed'
      ...
      <div className="max-w-4xl mx-auto space-y-8">
        ...
        <div className="text-center">
          ...
          <p className="text-gray-400 mb-4">
            Real-time social feed powered by vanilla Multisynq
          </p>
        ...
        <div className="flex justify-center">
          <VanillaMultisynqSocialFeed className="w-full max-w-2xl" />
        </div>
        ...
        <Card className="bg-gray-800 border-gray-700">
          ...
          <CardContent className="text-gray-300 space-y-2 text-sm">
            <p><strong>Framework:</strong> Vanilla Multisynq (similar to your example)</p>
            <p><strong>Real-time Engine:</strong> Multisynq Client Library</p>
            <p><strong>State Management:</strong> Server-side with client synchronization</p>
            <p><strong>Features:</strong> Create posts, like posts, real-time updates</p>
            <p><strong>Session:</strong> Shared across all users</p>
          </CardContent>
        </Card>
      </div>
    </div>
